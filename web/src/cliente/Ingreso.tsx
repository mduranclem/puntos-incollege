/**
 * Entrar a la cuenta: teléfono y después el código que llega por WhatsApp.
 *
 * Dos pasos y nada más. Sin registro, sin contraseña, sin correo.
 */
  ...
  return (
    <div className="ingreso-cliente">
      <div className="ingreso-caja">
        <div className="ingreso-estrella" aria-hidden="true">★</div>
        ...
        {paso === 'telefono' ? (
          ...
          <form onSubmit={confirmar} noValidate>
            <p className="ingreso-texto">
              Te mandamos un código de 6 números por WhatsApp a{' '}
              <strong>{telefonoLindo}</strong>.
            </p>
